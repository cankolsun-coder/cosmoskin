...
export async function onRequestGet(context) { return handleApi(async () => { const { supabase, user } = await requireAccount(context); return ok(await getLastOrder(supabase, user)); }); }
