...
export function renderRestockEmail({ productName = 'Beklediğin ürün', productUrl = '', productSlug = '', productImage = '', env = {} } = {}) {
  ...
  const productMedia = product.image
    ? `<table role="presentation" width="120" height="120" cellspacing="0" cellpadding="0" border="0" style="width:120px;height:120px;border-collapse:separate;"><tr><td align="center" valign="middle" width="120" height="120" style="width:120px;height:120px;border-radius:18px;border:1px solid #eee5dc;background:#faf7f3;text-align:center;vertical-align:middle;"><img src="${escapeHtml(product.image)}" width="104" alt="${escapeHtml(product.name)}" style="display:block;width:auto;height:auto;max-width:104px;max-height:104px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;margin:0 auto;"></td></tr></table>`
