...
## Fix
- The top navigation `Rutinler` link now points to the real physical page: `/account/routines/`.
- The homepage hero `RUTİNİ GÖR` link now points to `/account/routines/`.
- The homepage Smart Routine `Rutini Gör` JavaScript flow now points to `/account/routines/`.
- `/account/routines/` is now the stable smart route:
...
Aliases kept safely:
- `/collections/routine` => `/account/routines/` as internal 200 rewrite
- `/collections/routine.html` => `/account/routines/` as internal 200 rewrite
- `/routine.html` => `/account/routines/` as internal 200 rewrite
- `/rutinler` => `/account/routines/` as internal 200 rewrite
- `/rutinler.html` => `/account/routines/` as internal 200 rewrite
...
## QA checklist
- Top nav Rutinler link target checked: `/account/routines/`
- Hero RUTİNİ GÖR link target checked: `/account/routines/`
- Smart routine JS redirect checked: `/account/routines/`
