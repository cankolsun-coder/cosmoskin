# COSMOSKIN Club + Footer Production Patch — 25.06.2026

## Scope
- Preserved the existing COSMOSKIN site skeleton and static HTML architecture.
- Standardized footer structure, payment methods, social icons, and COSMOSKIN Club footer placement.
- Added customer-facing COSMOSKIN Club page and legal COSMOSKIN Club Kuralları page.
- Updated shared runtime normalizer so payment/social fixes are not overwritten after page load.

## Inspected files
- Public HTML files inspected: 167
- Footer-bearing HTML files validated: 137
- Shared styling/runtime files inspected: assets/style.css, assets/cosmoskin-fixes.css, assets/legal-site.css, assets/site-chrome.js

## Newly created files
- cosmoskin-club.html
- legal/cosmoskin-club-kurallari.html
- COSMOSKIN_CLUB_FOOTER_PATCH_MANIFEST_20260625.txt
...
- COSMOSKIN Club is placed under the Corporate/Kurumsal footer column and links to /cosmoskin-club.html.
- COSMOSKIN Club Kuralları is placed under the Legal/Yasal footer column and links to /legal/cosmoskin-club-kurallari.html.

## QA confirmation
- Payment methods are consistently ordered: iyzico, Visa, Mastercard, Troy, Havale/EFT.
- Legacy card brand/Legacy card brand is not shown in the footer payment method area.
- Instagram and TikTok footer icons use matching inline SVG sizing and accessible labels.
- Legal-page header wordmark is COSMOSKIN across all legal pages.
- No Turkish national ID field appears in the package.
- No forbidden live text terms were found in the modified files.
- No incorrect public HTML brand spelling was found in the inspected public HTML files.
