(function () {
  ...
  const SEARCH_INDEX_STATIC = [
    ...
    { label: 'Karma Cilt', type: 'Cilt Tipi', url: '/routine.html', keywords: 'combination skin karma cilt denge rutin', meta: 'Günlük denge için sabah-akşam akışları', badge: 'Cilt Tipi' },
    ...
    { label: 'Rutinler', type: 'Sayfa', url: '/routine.html', keywords: 'rutinler routine cilt bakim rutini sabah aksam', meta: 'Hazır sabah-akşam akışları', badge: 'Sayfa' },
  ...
  function renderSearchResults(container, results, query = '') {
    if (!container) return;
    if (!results.length) {
      container.innerHTML = '<div class="site-search-empty"><strong>Sonuç bulunamadı.</strong><span>Farklı bir ürün, kategori, içerik veya marka deneyin.</span><a class="site-search-empty__link" href="/routine.html">Rutinleri incele</a></div>';
