(function(){
  ...
  function createSearchSheet(){
    ...
    const links = [
      ['/cleanse.html','Temizleyiciler'], ['/hydrate.html','Nem & Bariyer'], ['/treat.html','Hedef Bakım'], ['/protect.html','SPF'], ['/collections/routine','Rutinler']
    ];
  ...
  function addBottomNav(){
    ...
    nav.innerHTML = `
      ...
      <a href="/collections/routine" class="${routineActive ? 'is-active' : ''}"><span class="mobile-bottom-nav__icon">✦</span><span>Rutinim</span></a>
  ...
  function addPagePills(){
    ...
    wrap.innerHTML = `
      ...
      <a href="/collections/routine">Rutinler</a>
