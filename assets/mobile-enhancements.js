(function(){
  ...
  function createSearchSheet(){
    ...
    const links = [
      ['/cleanse.html','Temizleyiciler'], ['/hydrate.html','Nem & Bariyer'], ['/treat.html','Hedef Bakım'], ['/protect.html','SPF'], ['/account/routines/','Rutinler']
    ];
  ...
  function addBottomNav(){
    ...
    nav.innerHTML = `
      ...
      <a href="/account/routines/" class="${routineActive ? 'is-active' : ''}"><span class="mobile-bottom-nav__icon">✦</span><span>Rutinim</span></a>
  ...
  function addPagePills(){
    ...
    wrap.innerHTML = `
      ...
      <a href="/account/routines/">Rutinler</a>
