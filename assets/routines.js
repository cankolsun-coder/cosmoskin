(function () {
  ...
  var ROUTINE_ROUTE = '/collections/routine.html';
  ...
  function summaryBar(prefs) {
    return '<div class="rt-summary-bar rt-card">' +
      ...
      '<a class="rt-btn" href="/collections/routine.html?view=profile">' + icon('edit') + 'Profili Düzenle</a></div>';
  }
  ...
  function renderDashboard(host) {
    ...
    host.innerHTML = '<section class="rt-section"><div class="rt-container">' +
      ...
      '<div class="rt-shell">' + sidebar('dashboard') + '<div class="rt-content">' +
        ...
        '<div class="rt-products-head"><div><h2>Önerilen Ürünler</h2><p>Cilt profiline %90+ uyumlu ürünler</p></div><div><button class="rt-btn rt-btn--black" type="button" data-rt-add-all>' + icon('bag') + 'Tümünü Sepete Ekle</button> <a class="rt-btn" href="/collections/routine.html?view=profile">' + icon('edit') + 'Rutinini Düzenle</a></div></div>' +
  ...
  function renderProfile(host) {
    ...
    host.innerHTML = '<section class="rt-section"><div class="rt-container"><div class="rt-shell">' + sidebar('profile') + '<div class="rt-content"><div class="rt-profile-grid"><div><h1 class="rt-h1" style="font-size:52px">Cilt Profilini Düzenle</h1><p class="rt-copy">Cilt profilini güncelle, sana özel ve daha isabetli öneriler al.</p><div class="rt-reason" style="margin:22px 0 18px">' + icon('info') + '<p>Bu bilgiler, rutinin senin cildine en uygun şekilde oluşturulmasına yardımcı olur. Aynı ürünleri önermemek ve içerik uyumunu artırmak için kullanılır.</p></div>' +
      ...
      '<div class="rt-profile-actions"><button class="rt-btn rt-btn--black" type="button" data-rt-save-profile>Kaydet ve Güncelle</button><a class="rt-btn" href="/collections/routine.html">İptal</a><button class="rt-btn" type="button" data-rt-reset-profile>Varsayılanlara Dön</button></div></div>' +
  ...
  function openAuth(mode) {
    ...
    window.location.href = '/index.html?next=' + encodeURIComponent('/collections/routine.html?routineSync=1');
  }
  ...
  function bindPage(host) {
    document.addEventListener('click', function (event) {
      ...
      var routineAnchor = event.target.closest('a[href^="/collections/routine.html"]');
      if (routineAnchor) {
