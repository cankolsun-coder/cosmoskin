(function () {
  ...
  function renderEmailsTab(order) {
    ...
    if (order.payment_method === 'bank_transfer' || order.payment_status === 'awaiting_transfer' || order.status === 'pending_bank_transfer') buttons.splice(1, 0, ['bank_transfer_pending', 'Havale/EFT bekleme e-postasını gönder']);
