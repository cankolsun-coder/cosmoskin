...
var CATS = [
  ...
  {label:'Set',         icon:'set',      href:'/account/routines/'}
];
...
function buildEditorial(){
  ...
  copy.innerHTML =
    ...
    '<a class="editorial-showcase__cta" href="/account/routines/">' +
...
function buildBottomNav(){
  ...
  nav.innerHTML =
    ...
    '<a class="m-tab' + (isRoutine?' is-active':'') + '" href="/account/routines/" aria-label="Rutinim">' + SVG.set + '<span>Rutinim</span></a>' +
