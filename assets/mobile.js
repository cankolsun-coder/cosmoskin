...
var CATS = [
  ...
  {label:'Set',         icon:'set',      href:'/collections/routine'}
];
...
function buildEditorial(){
  ...
  copy.innerHTML =
    ...
    '<a class="editorial-showcase__cta" href="/collections/routine">' +
...
function buildBottomNav(){
  ...
  nav.innerHTML =
    ...
    '<a class="m-tab' + (isRoutine?' is-active':'') + '" href="/collections/routine" aria-label="Rutinim">' + SVG.set + '<span>Rutinim</span></a>' +
