(function () {
  ...
  function bottomNav(active) {
    var items = [
      ...
      ['routine', 'Rutinim', '/collections/routine', 'routine'],
  ...
  function explorePage() {
    ...
    var routineCards = [
      ['Sabah Işıltısı', 'Hafif temizleme, nem ve SPF ile aydınlık başlangıç.', '/collections/routine?period=day', productImageForCategory('Güneş Koruyucular')],
      ['Akşam Rahatlaması', 'Arındırma, bariyer desteği ve gece konforu.', '/collections/routine?period=night', productImageForCategory('Nemlendiriciler')],
      ['Minimal & Etkili', 'Az ürünle düzenli ve ölçülü bakım akışı.', '/collections/routine', productImageForCategory('Serum & Ampul')]
    ];
    var articles = [
    ...
    return '<div class="cm-mobile-page cm-mobile-account cm-mobile-account--auth">' +
      ...
      '<div class="cm-page-inner cm-page-inner--top">' +
        '<section class="cm-auth-hero" aria-labelledby="cmAuthTitle">' +
          '<p>ÜYE GİRİŞİ</p>' +
          '<h1 id="cmAuthTitle">Hesabına giriş yap.</h1>' +
  ...
  function sheetHtml(kind) {
    if (kind === 'menu') {
      var primary = [
        ...
        ['/collections/routine', 'Akıllı Rutin', 'bottle']
      ];
      var secondary = [
