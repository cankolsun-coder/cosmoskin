(function () {
  ...
  function bottomNav(active) {
    var items = [
      ...
      ['routine', 'Rutinim', '/account/routines.html', 'routine'],
  ...
  function explorePage() {
    ...
    var routineCards = [
      ['Sabah Işıltısı', 'Hafif temizleme, nem ve SPF ile aydınlık başlangıç.', '/account/routines.html?period=day', productImageForCategory('Güneş Koruyucular')],
      ['Akşam Rahatlaması', 'Arındırma, bariyer desteği ve gece konforu.', '/account/routines.html?period=night', productImageForCategory('Nemlendiriciler')],
      ['Minimal & Etkili', 'Az ürünle düzenli ve ölçülü bakım akışı.', '/account/routines.html', productImageForCategory('Serum & Ampul')]
    ];
    var articles = [
  ...
  function sheetHtml(kind) {
    if (kind === 'menu') {
      var primary = [
        ...
        ['/account/routines.html', 'Akıllı Rutin', 'bottle']
      ];
      var secondary = [
