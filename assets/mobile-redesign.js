(function () {
  ...
  function bottomNav(active) {
    var items = [
      ...
      ['routine', 'Rutinim', '/collections/routine.html', 'routine'],
  ...
  function explorePage() {
    ...
    var routineCards = [
      ['Sabah Işıltısı', 'Hafif temizleme, nem ve SPF ile aydınlık başlangıç.', '/collections/routine.html?period=day', productImageForCategory('Güneş Koruyucular')],
      ['Akşam Rahatlaması', 'Arındırma, bariyer desteği ve gece konforu.', '/collections/routine.html?period=night', productImageForCategory('Nemlendiriciler')],
  ...
  function sheetHtml(kind) {
    if (kind === 'menu') {
      var primary = [
        ...
        ['/collections/routine.html', 'Akıllı Rutin', 'bottle']
      ];
      var secondary = [
